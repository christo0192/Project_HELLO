/**
 * HELLO navigation icon set — inline SVG (no icon dependency).
 *
 * All icons inherit `currentColor`, are `aria-hidden`, and use
 * `strokeWidth={2}` round-capped strokes to match the restrained
 * design system. Icons are decorative; every interactive element
